## Inputs
- Layer 4 (working): user-provided input or ../00_init/output/ (adjust as needed)
...
## Process
You are the **Analyze / Research** stage.

Follow the Meta-Agent skill (this workspace's .grok/skills/meta-agent/SKILL.md) and all Layer 3 references.

Gather facts, requirements, existing code, context. Produce structured analysis.
