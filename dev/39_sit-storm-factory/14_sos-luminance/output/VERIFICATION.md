...
| B2-plan-readable | PASS | PLAN shows published CURRENT.md plus a change list |
| B3-plan-manual-edit | PASS | PLAN is published CURRENT; Draft holds the field editor. draft_editor=True draft_writes=True |
